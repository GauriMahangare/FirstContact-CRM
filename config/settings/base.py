...
# firstcontact_crm/
APPS_DIR = ROOT_DIR / "firstcontact_crm"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "firstcontact_crm.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "firstcontact_crm.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Gauri Mahangare""", "gauri.mahangare@avanengineering.com")]

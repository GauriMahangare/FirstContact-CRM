...
class OrganisationModelForm(forms.ModelForm):
    class Meta:
        ...
        # widgets = {
        #     'work_org_name': forms.CharField(attrs={'class':'form-control','placeholder': 'Work Organisation Name'}),
        #     'work_address_line1': forms.CharField(attrs={'class':'form-control','placeholder': 'Address Line 1'}),
        #     'work_address_line2': forms.CharField(attrs={'class':'form-control','placeholder': 'Address Line 2'}),
        #     'work_address_line3': forms.CharField(attrs={'class':'form-control','placeholder': 'Address Line 3'}),
        #     'work_address_line4': forms.CharField(attrs={'class':'form-control','placeholder': 'Address Line 4'}),
        #     'work_address_postcode': forms.CharField(attrs={'class':'form-control','placeholder': 'PostCode'}),
        # }

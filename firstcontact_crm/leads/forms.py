...
class LeadModelForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "profile_picture": forms.widgets.ClearableFileInput(attrs={'class': 'form-control-file'}),
...
class NoteModelForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'notes': forms.Textarea(attrs={'class': 'form-control', 'cols': 45, 'rows': 10}),
            'file': forms.widgets.ClearableFileInput(attrs={'class': 'form-control-file', 'cols': 45, 'rows': 10}),
        }
